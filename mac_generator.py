...
def main():
    ...
    parser.add_argument('--oui',
                        help='enforces a specific organizationally unique identifier (like 00:60:2f for Cisco)')
    ...
    return generate_mac(oui=args.oui, uaa=args.uaa, multicast=args.multicast, separator=args.separator,
                        byte_fmt=args.byte_fmt)
